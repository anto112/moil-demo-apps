...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(1160, 702)
        font = QtGui.QFont()
        ...
        self.original_source.setGeometry(QtCore.QRect(20, 70, 400, 300))
        ...
        self.Main_window.setGeometry(QtCore.QRect(440, 70, 700, 525))
        self.Main_window.setStyleSheet("background-color: rgb(46, 52, 54);")
        self.Main_window.setText("")
        self.Main_window.setAlignment(QtCore.Qt.AlignCenter)
        self.Main_window.setObjectName("Main_window")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(0, 0, 1165, 40))
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 5, 110, 30))
        font = QtGui.QFont()
        ...
        self.open_image.setGeometry(QtCore.QRect(135, 5, 40, 30))
        ...
        self.label_3.setGeometry(QtCore.QRect(220, 0, 150, 40))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        self.label_3.setFont(font)
        self.label_3.setStyleSheet("color: rgb(206, 92, 0);")
        self.label_3.setObjectName("label_3")
        
        self.lineEdit = QtWidgets.QLabel(self.frame)
        self.lineEdit.setGeometry(QtCore.QRect(350, 5, 200, 30))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 45, 400, 25))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.label_5.setGeometry(QtCore.QRect(440, 45, 601, 25))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.rotate_left.setGeometry(QtCore.QRect(1040, 45, 50, 25))
        ...
        self.rotate_right.setGeometry(QtCore.QRect(1090, 45, 50, 25))
        ...
        self.label_11.setGeometry(QtCore.QRect(20, 375, 400, 25))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.normal_view.setGeometry(QtCore.QRect(30, 410, 200, 23))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.anypoint_view.setGeometry(QtCore.QRect(30, 440, 201, 23))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.panorama_view.setGeometry(QtCore.QRect(30, 570, 201, 23))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(189, 450, 210, 100))
        ...
        blue = QtGui.QPixmap(800, 600)
        blue.fill(QtCore.Qt.transparent)
        p = QtGui.QPainter(blue)
        pen = QtGui.QPen(QtGui.QBrush(QtGui.QColor(238, 238, 236)), 1.5)
        p.setPen(pen)
        p.drawLine(390, 300, 410, 300)
        p.drawLine(400, 290, 400, 310)
        p.end()
        self.plus_icon.setPixmap(blue)

        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(50, 470, 120, 80))
        ...
        self.label_12.setGeometry(QtCore.QRect(440, 600, 700, 50))
        font = QtGui.QFont()
        font.setFamily("Serif")
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 400, 400, 250))
        self.groupBox_2.setStyleSheet("border-width:3px;\n"
                                      "border: 1px solid black;")
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.panoX_view = QtWidgets.QRadioButton(self.centralwidget)
        self.panoX_view.setGeometry(QtCore.QRect(30, 605, 141, 23))
        font = QtGui.QFont()
        font.setFamily("Serif")
        font.setPointSize(14)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../screening_colonoscopy/assets/camera_live.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        self.actionOpen_Cam.setIcon(icon5)
        self.actionOpen_Cam.setObjectName("actionOpen_Cam")
        self.actionClose_Cam = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../screening_colonoscopy/assets/stop.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionClose_Cam.setIcon(icon6)
        self.actionClose_Cam.setObjectName("actionClose_Cam")
        self.actionExit = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../screening_colonoscopy/assets/exit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
